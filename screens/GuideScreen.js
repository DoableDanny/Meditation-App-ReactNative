    ...
    <ScrollView>
      <LinearGradient
        ...
        <Text style={styles.text}>
          ...
          gets you 1 star, 45 mins = 2 stars and 60 mins for a glorious 3 stars!
        </Text>
        ...
        <Text style={styles.text}>
          ...
          of 1 hour meditations to truly feel the benefits. I have found this to
          be true.
        </Text>
        <Text style={styles.text}>
          Jiddu Krishnamurti's books: Freedom from the Known, Think on These
          Things and Total Freedom. A man that introduced me to a new defintion
          of freedom. Freedom from ourselves.
        </Text>
        <Text style={styles.text}>
          The Stoics: Seneca's letters from a Stoic, Marcus Aurelius's
          Meditations and Epictetus's Letters and Discourses. You are
          responsible for yourself and your thoughts, let go of everything else
